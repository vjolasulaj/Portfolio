  ...
  return (
    <div className="home-data">
      ...
      <p className="home-paragraph">
        I'm a frontend developer specializing in creating user-facing interfaces
        for web applications. I have strong skills in HTML, CSS, Bootstrap and
        JavaScript, and I'm proficient in framework React. I also have
        proficiency in the responsiveness of website pages.
      </p>
    </div>
  );
};
