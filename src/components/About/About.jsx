...
const About = () => {
  return (
    <section className="about section" id="about">
      ...
      <div className="about-me container grid">
        <div className="about-data">
          <p>
            I am a passionate Front End Developer with a keen eye for detail and
            a love for creating seamless user experiences. I specialize in HTML,
            CSS, and JavaScript, and I'm proficient in modern frameworks like
